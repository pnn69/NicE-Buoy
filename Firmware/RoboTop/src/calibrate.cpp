...
double sailedDir = -1;
/**
 * @brief Executes the compass offset calibration sequence.
 * 
 * Sets the buoy to sail in a specific direction for a set duration, measures
 * the actual direction sailed based on GPS, calculates the offset, and commands
 * the system to store it. Returns the buoy to its home position afterwards.
 * 
