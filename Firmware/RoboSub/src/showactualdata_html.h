...
<body>
    ...
    <!-- Heading Filter Output Selector Card -->
    <div style="max-width: 1200px; width: 100%; margin: 20px auto 10px auto; padding: 0 20px;">
        <div class="card" style="background: var(--card-bg); border: 1px solid var(--border); border-radius: 12px; padding: 20px;">
            <h2 style="font-size: 1.25rem; font-weight: 700; margin-bottom: 15px; color: var(--text-color); display: flex; align-items: center; gap: 8px;">
                <svg width="20" height="20" fill="none" stroke="var(--primary)" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/></svg>
                Active Navigation Filter Selector
            </h2>
            <div style="display: flex; flex-wrap: wrap; gap: 1rem; align-items: center;">
                
                <!-- Mode 0: Raw -->
                <label style="flex: 1; min-width: 180px; background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border); display: flex; align-items: center; gap: 10px; cursor: pointer; transition: all 0.2s;">
                    <input type="radio" name="icm-mode" value="0" style="accent-color: #9ca3af; transform: scale(1.15);" onchange="setIcmMode(0)">
                    <div>
                        <div style="font-weight: bold; font-size: 0.85rem; color: #9ca3af;">1. Raw Data</div>
                        <div style="font-size: 0.65rem; color: var(--text-muted);">Uncompensated 2D heading</div>
                    </div>
                </label>

                <!-- Mode 1: Hard Iron -->
                <label style="flex: 1; min-width: 180px; background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border); display: flex; align-items: center; gap: 10px; cursor: pointer; transition: all 0.2s;">
                    <input type="radio" name="icm-mode" value="1" style="accent-color: #38bdf8; transform: scale(1.15);" onchange="setIcmMode(1)">
                    <div>
                        <div style="font-weight: bold; font-size: 0.85rem; color: #38bdf8;">2. Hard Iron</div>
                        <div style="font-size: 0.65rem; color: var(--text-muted);">Offsets compensation only</div>
                    </div>
                </label>

                <!-- Mode 2: Both Iron -->
                <label style="flex: 1; min-width: 180px; background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border); display: flex; align-items: center; gap: 10px; cursor: pointer; transition: all 0.2s;">
                    <input type="radio" name="icm-mode" value="2" style="accent-color: #8b5cf6; transform: scale(1.15);" onchange="setIcmMode(2)">
                    <div>
                        <div style="font-weight: bold; font-size: 0.85rem; color: #8b5cf6;">3. Both Iron Comp</div>
                        <div style="font-size: 0.65rem; color: var(--text-muted);">Offsets + Soft scaling</div>
                    </div>
                </label>

                <!-- Mode 3: Tilt Compensated -->
                <label style="flex: 1; min-width: 180px; background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border); display: flex; align-items: center; gap: 10px; cursor: pointer; transition: all 0.2s;">
                    <input type="radio" name="icm-mode" value="3" style="accent-color: #f59e0b; transform: scale(1.15);" onchange="setIcmMode(3)">
                    <div>
                        <div style="font-weight: bold; font-size: 0.85rem; color: #f59e0b;">4. Tilt Compensated</div>
                        <div style="font-size: 0.65rem; color: var(--text-muted);">Iron Comp + Pitch & Roll</div>
                    </div>
                </label>

                <!-- Mode 4: 3D Fusion -->
                <label id="label-mode-4" style="flex: 1; min-width: 180px; background: rgba(16, 185, 129, 0.04); padding: 12px; border-radius: 8px; border: 1px solid rgba(16, 185, 129, 0.25); display: flex; align-items: center; gap: 10px; cursor: pointer; transition: all 0.2s;">
                    <input type="radio" name="icm-mode" value="4" style="accent-color: #10b981; transform: scale(1.15);" onchange="setIcmMode(4)">
                    <div>
                        <div style="font-weight: bold; font-size: 0.85rem; color: #10b981;">5. Dynamic 3D Fusion</div>
                        <div style="font-size: 0.65rem; color: var(--text-muted);">Full Tilt + Gyro Damped</div>
                    </div>
                </label>
    ...
    <div style="max-width: 1200px; width: 100%; margin: 20px auto 10px auto; padding: 0 20px;">
        <div class="card" style="background: var(--card-bg); border: 1px solid var(--border); border-radius: 12px; padding: 20px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.5rem;">
                ...
                <!-- Accelerometer Damping -->
                <div style="background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border);">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 6px; align-items: center;">
                        <span style="font-weight: bold; font-size: 0.85rem; color: #38bdf8;">Accelerometer Damping</span>
                        <span id="damping-val-acc" style="font-family: monospace; font-weight: bold; font-size: 0.95rem; color: #38bdf8;">0.15</span>
                    </div>
                    <input type="range" id="damping-slider-acc" min="0.01" max="1.0" step="0.01" value="0.15" style="width: 100%; accent-color: #38bdf8; background: rgba(255,255,255,0.05); border-radius: 4px; height: 6px; cursor: pointer; border: none; outline: none;">
                ...
                <div style="background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border);">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 6px; align-items: center;">
                        <span style="font-weight: bold; font-size: 0.85rem; color: #10b981;">Gyroscope Damping</span>
                        <span id="damping-val-gyro" style="font-family: monospace; font-weight: bold; font-size: 0.95rem; color: #10b981;">0.15</span>
                    </div>
                    <input type="range" id="damping-slider-gyro" min="0.01" max="1.0" step="0.01" value="0.15" style="width: 100%; accent-color: #10b981; background: rgba(255,255,255,0.05); border-radius: 4px; height: 6px; cursor: pointer; border: none; outline: none;">
                    <div style="display: flex; justify-content: space-between; font-size: 0.65rem; color: var(--text-muted); margin-top: 4px;">
                        <span>0.01 (Heavy)</span>
                        <span>1.00 (None)</span>
                    </div>
                ...
                <!-- Magnetometer Damping -->
                <div style="background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border);">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 6px; align-items: center;">
                        <span style="font-weight: bold; font-size: 0.85rem; color: #8b5cf6;">Magnetometer Damping</span>
                        <span id="damping-val-mag" style="font-family: monospace; font-weight: bold; font-size: 0.95rem; color: #8b5cf6;">0.15</span>
                    </div>
                    <input type="range" id="damping-slider-mag" min="0.01" max="1.0" step="0.01" value="0.15" style="width: 100%; accent-color: #8b5cf6; background: rgba(255,255,255,0.05); border-radius: 4px; height: 6px; cursor: pointer; border: none; outline: none;">
                    <div style="display: flex; justify-content: space-between; font-size: 0.65rem; color: var(--text-muted); margin-top: 4px;">
                        <span>0.01 (Heavy)</span>
                        <span>1.00 (None)</span>
                    </div>
                ...
                <div style="background: rgba(0,0,0,0.15); padding: 12px; border-radius: 8px; border: 1px solid var(--border);">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 6px; align-items: center;">
                        <span style="font-weight: bold; font-size: 0.85rem; color: #f59e0b;">Attitude Damping</span>
                        <span id="damping-val-att" style="font-family: monospace; font-weight: bold; font-size: 0.95rem; color: #f59e0b;">0.15</span>
                    </div>
                    <input type="range" id="damping-slider-att" min="0.01" max="1.0" step="0.01" value="0.15" style="width: 100%; accent-color: #f59e0b; background: rgba(255,255,255,0.05); border-radius: 4px; height: 6px; cursor: pointer; border: none; outline: none;">
                    <div style="display: flex; justify-content: space-between; font-size: 0.65rem; color: var(--text-muted); margin-top: 4px;">
                        <span>0.01 (Heavy)</span>
                        <span>1.00 (None)</span>
                    </div>
    ...
    <script>
        ...
        // Damping variables for displayed values
        let dampedMxRaw = 0, dampedMyRaw = 0, dampedMzRaw = 0;
        let dampedMxCal = 0, dampedMyCal = 0, dampedMzCal = 0;
        ...
        function setIcmMode(mode) {
            fetch(`/set_icm_mode?mode=${mode}`)
                .then(response => response.text())
                .then(text => {
                    if (text === "OK") {
                        console.log(`Successfully switched navigation filter to Mode ${mode}`);
                    } else {
                        alert(`Failed to set navigation filter: ${text}`);
                    }
                })
        ...
        function initDampingSliders() {
            // Accelerometer Damping Slider
            const sliderAcc = document.getElementById('damping-slider-acc');
            const valAcc = document.getElementById('damping-val-acc');
            let k_acc = parseFloat(localStorage.getItem('damping_factor_acc')) || 0.15;
            sliderAcc.value = k_acc;
            valAcc.innerText = k_acc.toFixed(2);
            sliderAcc.oninput = function() {
                localStorage.setItem('damping_factor_acc', this.value);
                valAcc.innerText = parseFloat(this.value).toFixed(2);
            };
            sliderAcc.onchange = function() {
                fetch(`/set-damping?sensor=acc&val=${this.value}`).catch(err => console.error(err));
            };

            // Gyroscope Damping Slider
            const sliderGyro = document.getElementById('damping-slider-gyro');
            const valGyro = document.getElementById('damping-val-gyro');
            let k_gyro = parseFloat(localStorage.getItem('damping_factor_gyro')) || 0.15;
            sliderGyro.value = k_gyro;
            valGyro.innerText = k_gyro.toFixed(2);
            sliderGyro.oninput = function() {
                localStorage.setItem('damping_factor_gyro', this.value);
                valGyro.innerText = parseFloat(this.value).toFixed(2);
            };
            sliderGyro.onchange = function() {
                fetch(`/set-damping?sensor=gyro&val=${this.value}`).catch(err => console.error(err));
            };

            // Magnetometer Damping Slider
            const sliderMag = document.getElementById('damping-slider-mag');
            const valMag = document.getElementById('damping-val-mag');
            let k_mag = parseFloat(localStorage.getItem('damping_factor_mag')) || 0.15;
            sliderMag.value = k_mag;
            valMag.innerText = k_mag.toFixed(2);
            sliderMag.oninput = function() {
                localStorage.setItem('damping_factor_mag', this.value);
                valMag.innerText = parseFloat(this.value).toFixed(2);
            };
            sliderMag.onchange = function() {
                fetch(`/set-damping?sensor=mag&val=${this.value}`).catch(err => console.error(err));
            };

            // Attitude Damping Slider
            const sliderAtt = document.getElementById('damping-slider-att');
            const valAtt = document.getElementById('damping-val-att');
            let k_att = parseFloat(localStorage.getItem('damping_factor_att')) || 0.15;
            sliderAtt.value = k_att;
            valAtt.innerText = k_att.toFixed(2);
            sliderAtt.oninput = function() {
                localStorage.setItem('damping_factor_att', this.value);
                valAtt.innerText = parseFloat(this.value).toFixed(2);
            };
            sliderAtt.onchange = function() {
                fetch(`/set-damping?sensor=att&val=${this.value}`).catch(err => console.error(err));
            };
        }
        ...
        function initWebSockets() {
            ...
            function poll() {
                fetch('/data')
                    ...
                    .then(data => {
                        // Load dynamic damping coefficients from localStorage
                        let k_acc = parseFloat(localStorage.getItem('damping_factor_acc')) || 0.15;
                        let k_gyro = parseFloat(localStorage.getItem('damping_factor_gyro')) || 0.15;
                        let k_mag = parseFloat(localStorage.getItem('damping_factor_mag')) || 0.15;
                        let k_att = parseFloat(localStorage.getItem('damping_factor_att')) || 0.15;

                        // Synchronize damping sliders with NVS values on the first poll
                        if (!isNvsSynced && data.damp_acc !== undefined) {
                            isNvsSynced = true;
                            
                            k_acc = parseFloat(data.damp_acc);
                            document.getElementById('damping-slider-acc').value = k_acc;
                            document.getElementById('damping-val-acc').innerText = k_acc.toFixed(2);
                            localStorage.setItem('damping_factor_acc', k_acc);

                            k_gyro = parseFloat(data.damp_gyro);
                            document.getElementById('damping-slider-gyro').value = k_gyro;
                            document.getElementById('damping-val-gyro').innerText = k_gyro.toFixed(2);
                            localStorage.setItem('damping_factor_gyro', k_gyro);

                            k_mag = parseFloat(data.damp_mag);
                            document.getElementById('damping-slider-mag').value = k_mag;
                            document.getElementById('damping-val-mag').innerText = k_mag.toFixed(2);
                            localStorage.setItem('damping_factor_mag', k_mag);

                            k_att = parseFloat(data.damp_att);
                            document.getElementById('damping-slider-att').value = k_att;
                            document.getElementById('damping-val-att').innerText = k_att.toFixed(2);
                            localStorage.setItem('damping_factor_att', k_att);
                        }

                        // Angle EMA filter with modular wrap-around 0/360 boundary protection
                        function dampAngle(current, target, k) {
                            if (current === 0 && target !== 0) return target;
                            let diff = target - current;
                            if (diff > 180) diff -= 360;
                            if (diff < -180) diff += 360;
                            let damped = current + k * diff;
                            return (damped % 360 + 360) % 360;
                        }

                        headingRaw = dampAngle(headingRaw, data.raw, k_mag);
                        headingHard = dampAngle(headingHard, data.hard, k_mag);
                        ...
                        // Apply attitude damping
                        currentRoll = currentRoll * (1 - k_att) + rollVal * k_att;
                        currentPitch = currentPitch * (1 - k_att) + pitchVal * k_att;
                        ...
                        // Apply Accelerometer/Gyroscope damping variables to displayed raw and calibrated magnetometer arrays
                        let mxRawTarget = data.mx_raw || 0;
                        let myRawTarget = data.my_raw || 0;
                        let mzRawTarget = data.mz_raw || 0;
                        dampedMxRaw = dampedMxRaw * (1 - k_acc) + mxRawTarget * k_acc;
                        dampedMyRaw = dampedMyRaw * (1 - k_acc) + myRawTarget * k_acc;
                        dampedMzRaw = dampedMzRaw * (1 - k_acc) + mzRawTarget * k_acc;

                        let mxCalTarget = data.mx_cal || 0;
                        let myCalTarget = data.my_cal || 0;
                        let mzCalTarget = data.mz_cal || 0;
                        dampedMxCal = dampedMxCal * (1 - k_acc) + mxCalTarget * k_acc;
                        dampedMyCal = dampedMyCal * (1 - k_acc) + myCalTarget * k_acc;
                        dampedMzCal = dampedMzCal * (1 - k_acc) + mzCalTarget * k_acc;

                        document.getElementById('val-raw-mag').innerText = `${Math.round(dampedMxRaw)}, ${Math.round(dampedMyRaw)}, ${Math.round(dampedMzRaw)}`;
                        ...
                        // Synchronize Active Filter Radio Button with the active mode
                        if (data.icm_mode !== undefined) {
                            let radios = document.getElementsByName('icm-mode');
                            for (let r of radios) {
                                if (parseInt(r.value) === data.icm_mode) {
                                    r.checked = true;
                                }
                            }
                        }
