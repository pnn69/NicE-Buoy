...
<div class="raw-box" style="display:flex;flex-direction:row;align-items:center;gap:15px;min-width:440px;max-width:550px;">
    <div style="display:flex;flex-direction:column;justify-content:center;flex:1.2;">
        ...
        <button onclick="location.href='/linearinterpolation'" style="background:#8b5cf6;color:white;width:100%;height:50px;margin-top:8px;font-weight:bold;font-size:0.95em;border-radius:4px;border:none;cursor:pointer;">➔ Linear Interpolation Table</button>
    </div>
